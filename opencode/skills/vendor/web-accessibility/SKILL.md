...
description: Use this skill whenever building, auditing, or fixing UI for accessibility compliance. Triggers include: creating accessible React/Vue/Vanilla JS components (buttons, forms, modals, dropdowns, tabs, navigation), fixing WCAG A/AA/AAA violations, implementing keyboard navigation or focus traps, adding ARIA attributes, ensuring color contrast requirements, writing axe-core or jest-axe accessibility tests, or any request mentioning "a11y", "screen reader", "WCAG", "aria", or "accessible".
---
